...
# chmod +x setup-kanata.sh
# sudo ./setup-kanata.sh
# sudo usermod -aG uinput $USER # (Run the above command to add your user to the uinput group, then log out and back in for it to take effect)
...
# (DO NOT EDIT)
SYSTEM_KANATA_CONFIG_DST="/etc/kanata/kanata.kbd"
